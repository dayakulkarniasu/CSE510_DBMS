...
public class query{
    ...
    public static void main(String args[]) throws Exception {
		...
		// Type: btree index type: 1-5 Ordertype:  ascendingorder in row, column, timestamp, and combination: 1-5
        ...
        //SystemDefs.JavabaseBM.flushAllPages(); //?-copied from minibase, but might need to modify
	...
	public static void runquery(String bigtablename, Integer type, Integer ordertype, String rowfilter, String columnfilter,  String valuefilter, numbuf) throws Exception {
		...
		case 1:
		   ...
		   query_op = hf.openscan
		   // while loop
		   //*
		   //signle value match
		   //range search
		   
		   System.out.println("select items:" + query_op);
           break;
		case 2:
           //type == 2;
		   bigT.Stream(bigt br, int orderType, String rowFilter, String columnFilter, String valueFilter);

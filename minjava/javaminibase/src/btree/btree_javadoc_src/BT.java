 ...
 *
 * For debug utilities, you could implement methods to print any page or the
 * whole B+ tree structure or all leaf pages.
 *
 */
public class BT implements GlobalConst {
   ...
   */
  public final static KeyDataEntry getEntryFromBytes(byte[] from, int offset, int length, int keyType, short nodeType)

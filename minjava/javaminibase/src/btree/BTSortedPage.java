...
public class BTSortedPage extends HFPage {
   ...
   */
  protected MID insertRecord(KeyDataEntry entry) throws InsertRecException {
    int i;
    short nType;
    MID mid;
    byte[] record;
    ...
    try {
      ...
      for (i = getSlotCnt() - 1; i > 0; i--) {
        ...
        key_iplus1 = BT.getEntryFromBytes(getpage(), getSlotOffset(i - 1), getSlotLength(i - 1), keyType, nType).key;
   ...
   */
  public boolean deleteSortedRecord(MID mid) throws DeleteRecException {
    try {

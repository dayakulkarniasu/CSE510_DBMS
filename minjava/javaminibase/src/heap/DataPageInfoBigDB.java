...
class DataPageInfoBigDB implements GlobalConst{
 ...
 */
   ...
   */
  public DataPageInfoBigDB(byte[] array)
  {
    data = array;
    offset = 0;
  }
   ...
   * @param amap: the input tuple
   */
  public DataPageInfoBigDB(Map _amap)

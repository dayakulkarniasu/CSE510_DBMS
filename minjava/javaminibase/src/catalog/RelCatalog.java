...
public class RelCatalog extends Heapfile implements GlobalConst, Catalogglobal {
      ...
      public void createRel(String relation, int attrCnt, attrInfo[] attrList)
                  ...
                  RelCatalogException, Catalogioerror, Cataloghferror {
            Heapfile rel;
            RelDesc rd = null;
            AttrDesc ad = null;
            int tupleWidth = 0;
      ...
      public void addIndex(String relation, String attrName, IndexType accessType, int buckets)
                  ...
                  java.lang.Exception, Catalogindexnotfound, Catalognomem, Catalogbadtype, Catalogattrnotfound,
                  Exception
      ...
      public void make_map(Map map, RelDesc record) throws IOException, RelCatalogException {
            try {
      ...
      public void read_map(Map map, RelDesc record) throws IOException, RelCatalogException {
            try {

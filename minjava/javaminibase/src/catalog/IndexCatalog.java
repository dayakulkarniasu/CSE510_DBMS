...
public class IndexCatalog extends Heapfile implements GlobalConst, Catalogglobal {
      ...
      public int getRelInfo(String relation, int indexCnt, IndexDesc[] indexes)
                  ...
                  Catalognomem, Catalogattrnotfound, IndexCatalogException, RelCatalogException, Catalogrelnotfound {
            RelDesc record = null;
            int status;
            int recSize;
            MID mid = null;
      ...
      public void addIndex(String relation, String attrName, IndexType accessType, int buckets)
                  ...
                  Catalogbadtype, Catalognomem, Catalogindexnotfound, IndexCatalogException, java.lang.Exception {
            MID mid = null;
      ...
      void make_map(Map map, IndexDesc record) throws IOException, IndexCatalogException {
            try {
                  ...
                  if (record.order.mapOrder == MapOrder.Ascending)
                        map.setIntFld(4, 0);
                  else if (record.order.mapOrder == MapOrder.Descending)
                        map.setIntFld(4, 1);
                  else if (record.order.mapOrder == MapOrder.Random)
                        map.setIntFld(4, 2);
                  else
      ...
      void read_map(Map map, IndexDesc record) throws IOException, IndexCatalogException {
            try {

...
public class AttrCatalog extends Heapfile implements GlobalConst, Catalogglobal {
	...
	public void make_map(Map map, AttrDesc record) throws IOException, AttrCatalogException {
		try {
	...
	public void read_map(Map map, AttrDesc record) throws IOException, AttrCatalogException {
		try {

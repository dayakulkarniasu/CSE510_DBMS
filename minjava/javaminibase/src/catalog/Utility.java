...
public class Utility implements Catalogglobal {
  ...
  void deleteRecIndexesUT(String relation, MID mid, Map map) {
  };

  // WRAPS INSERT UTILITY IN TX
  public static void insertRecordUT(String relation, int attrCnt, attrNode[] attrList) throws Catalogmissparam,
      Catalogrelexists, Catalogdupattrs, Catalognomem, IOException, Catalogioerror, Cataloghferror, Catalogrelnotfound,
      Catalogindexnotfound, Catalogattrnotfound, Catalogbadattrcount, Catalogattrexists, Catalogbadtype, Exception {
  ...
  public static void insertRecUT(String relation, int attrCnt, attrNode[] attrList) throws Catalogmissparam,
      Catalogrelexists, Catalogdupattrs, Catalognomem, IOException, Catalogioerror, Cataloghferror, Catalogrelnotfound,
      Catalogindexnotfound, Catalogattrnotfound, Catalogbadattrcount, Catalogattrexists, Catalogbadtype, Exception {
    RelDesc relRec = null;
    MID mid = null;
    ...
    heap.insertMap(map.getMapByteArray());
  ...
  // LOADS INDEXES
  void loadIndexesUT(Tuple tuple, int attrCnt, int indexCnt, AttrDesc[] attrs, IndexDesc[] indexes, void[] iFiles,
      MID mid) {
  };

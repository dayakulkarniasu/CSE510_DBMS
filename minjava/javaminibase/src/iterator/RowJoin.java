        ...
        while (inner_map != null) {
          ...
          while(!latestFound){
            ...
            if(inner_peek != null){
              ...
              if(MapUtils.CompareMapWithMap(new AttrType(AttrType.attrString), inner_map, GlobalConst.ROW_LABEL, inner_peek, GlobalConst.ROW_LABEL) == 0 &&
                      MapUtils.CompareMapWithMap(new AttrType(AttrType.attrString), inner_map, GlobalConst.COL_LABEL, inner_peek, GlobalConst.COL_LABEL) == 0) {

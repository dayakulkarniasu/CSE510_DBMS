...
public class Projection {
	 ...
	 */
	public static void Join(Map m1, AttrType type1[], Map m2, AttrType type2[], Map Jmap, FldSpec perm_mat[],
		...
		for (int i = 0; i < nOutFlds; i++) {
			...
			case RelSpec.outer: // Field of outer (t1)
				...
				case AttrType.attrReal:
					Jmap.setFloFld(i + 1, m1.getFloFld(perm_mat[i].offset));
					break;
			...
			case RelSpec.innerRel: // Field of inner (t2)
				...
				case AttrType.attrInteger:
					Jmap.setIntFld(i + 1, m2.getIntFld(perm_mat[i].offset));
					break;
				case AttrType.attrReal:
					Jmap.setFloFld(i + 1, m2.getFloFld(perm_mat[i].offset));
					break;
				case AttrType.attrString:
	...
	public static void Project(Map m1, AttrType type1[], Map Jmap, FldSpec perm_mat[], int nOutFlds)

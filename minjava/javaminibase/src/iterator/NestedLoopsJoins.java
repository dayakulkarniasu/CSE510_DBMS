...
public class NestedLoopsJoins extends Iterator {
  ...
  public NestedLoopsJoins(AttrType in1[], int len_in1, short t1_str_sizes[], AttrType in2[], int len_in2,
    ...
    nOutFlds = n_out_flds;
    try {
      t_size = MapUtils.setup_op_map(Jmap, Jtypes, in1, len_in1, in2, len_in2, t1_str_sizes, t2_str_sizes,
          proj_list, nOutFlds);
      ...
      while ((inner_map = inner.getNext(mid)) != null) {
        ...
        if (PredEval.Eval(RightFilter, inner_map, null, _in2, null) == true) {
          if (PredEval.Eval(OutputFilter, outer_map, inner_map, _in1, _in2) == true) {
            ...
            Projection.Join(outer_map, _in1, inner_map, _in2, Jmap, perm_mat, nOutFlds);
            return Jmap;
          }
        }
      }

...
private static final int finalnum_pgs = 20;
   ...
   */
/*  public void openDB(String fname, int type)
    throws IOException,
...
//initailze big table with the 5 schemes created
    ...
    DBFirstPage firstBIGDBpg = new DBFirstPage();
    firstBIGDBpg.openPage(apage);
    num_pages = firstBIGDBpg.getNumDBPages();
...
*/
  ...
  public void openbigDB( String fname , int num_pgs, int type)
    throws IOException,
	   InvalidPageNumberException,
	   FileIOException,
	   DiskMgrException {
    ...
    num_pages = (finalnum_pgs > 2) ? finalnum_pgs : 2;
    ...
    DBFirstPage firstBIGDBpg = new DBFirstPage(apage);

    firstBIGDBpg.setNumDBPages(num_pages);

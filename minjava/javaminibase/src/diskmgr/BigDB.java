...
public class bigDB implements GlobalConst {
    ...
    BTreeFile indexStrat1 = null;
    BTreeFile indexStrat2 = null;
     ...
     * Type 4: one btree to index column label and row label (combined key) and one
    ...
    public bigDB(int type) {
        ...
        switch (type) {
            ...
            case 2:
                // Index on RowLabel
                indexStrat1 = btreeindex.IndexForOneKey(PropertyType.RowLabel);
                break;
            case 3:
                // Index on ColumnLabel
                indexStrat1 = btreeindex.IndexForOneKey(PropertyType.ColumnLabel);
                break;
            case 4:
                // Index on combKey for ColumnLabel and RowLabel & Index on TimeStamp
                indexStrat1 = btreeindex.IndexForCombinedKey(PropertyType.ColumnLabel, PropertyType.RowLabel);
                indexStrat2 = btreeindex.IndexForOneKey(PropertyType.TimeStamp);

                break;
            case 5:
                // Index on combKey for RowLabel and Value & Index on TimeStamp
                indexStrat1 = btreeindex.IndexForCombinedKey(PropertyType.RowLabel, PropertyType.Value);
                indexStrat2 = btreeindex.IndexForOneKey(PropertyType.TimeStamp);
                break;
        }
    }

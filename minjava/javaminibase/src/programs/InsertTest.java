...
/*                                  if (SystemDefs.JavabaseDB.table == null) {
                                    big = new bigt(tablename, SystemDefs.JavabaseDB.dbType);
                                    System.out.println("JavabaseDB name is Null : " + SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex].name);
                                    //System.out.println("Exiting...... ");
                                  } else  {
                                    boolean found = false;
                                    int i;
                                    for (i=0; i < SystemDefs.JavabaseDB.NumberOfTables - 1; i++) {
                                      if ( tablename.equals(SystemDefs.JavabaseDB.table[i].name)) {
                                    ...
                                    if (found == false) {
                                       ...
                                       SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex].name = tablename;
                                       SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex].hf = new Heapfile(tablename);
                                       //SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex].BTType = 1;
                                       ...
                                       System.out.println("Heap File Name : " + name + " BTType : " + SystemDefs.JavabaseDB.table[0].BTType);
                                    }
                                    big = SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex];
                                    System.out.println("Table exist and Name is : " + SystemDefs.JavabaseDB.table[SystemDefs.JavabaseDB.CurrentTableIndex].name);
                                  }
*/
